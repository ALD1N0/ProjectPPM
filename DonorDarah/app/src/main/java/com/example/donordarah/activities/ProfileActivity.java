                    ...
                    if (userData != null) {
                        ...
                        donor.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                {
                                    Toast.makeText(ProfileActivity.this, "You are not a donor! Be a donor and save life by donating blood.",
                                        ...
                                        .addOnCompleteListener(ProfileActivity.this, new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                ...
                                                if (!task.isSuccessful()) {
                                                    ...
                                                    {
                                                        donor_ref.child(div).child(blood).child(id).child("UID").setValue(id);
